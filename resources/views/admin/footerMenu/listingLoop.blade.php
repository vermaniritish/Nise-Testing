	...
	<td class="text-center">
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
					<a class="dropdown-item" href="<?php echo route('admin.footerMenu.view', ['id' => $row->id]) ?>">
						<i class="fas fa-eye text-yellow"></i>
						<span class="status">View</span>
					</a>
					<div class="dropdown-divider"></div>
					<?php if(Permissions::hasPermission('footer_menu', 'update')): ?>
					 <a class="dropdown-item" href="<?php echo route('admin.footerMenu.edit', ['id' => $row->id]) ?>">
					...
					<a
						...
						href="javascript:;"
						data-link="<?php echo route('admin.footerMenu.delete', ['id' => $row->id]) ?>"
					>
