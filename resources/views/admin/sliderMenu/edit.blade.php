...
@section('content')
    ...
    <div class="container-fluid mt--6">
        ...
        <form method="post" action="<?php echo route('admin.sliderMenu.edit', $page->id); ?>" class="form-validation">
            <!--!! CSRF FIELD !!-->
            {{ @csrf_field() }}
            <div class="row">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="button_title"
                                        value="<?php echo $page->button_title ?? ''; ?>" placeholder="Button Title">
                                    @error('button_title')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="button_link"
                                        value="<?php echo $page->button_link ?? ''; ?>" placeholder="Button Link">
                                    @error('button_link')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="upload-image-section" data-type="image" data-multiple="false"
                                                ...
                                                <h6 class="heading-small text-muted mb-4">Upload Image Size Of 1440px *
                                                    597px</h6>
                                                <!-- INPUT WITH FILE URL -->
                                                <textarea class="d-none" name="image">{{ $page->image ?? '' }}</textarea>
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="button_title_hi"
                                        value="<?php echo $page->button_title_hi ?? ''; ?>" placeholder="Button Title">
