            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('admin.manageCenter') }}" class="btn btn-neutral">
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                ...
                @endif
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.manageCenter.edit', $center->id) }}" enctype="multipart/form-data">
                            @csrf 
                            <div class="row">
							    ...
							    <tbody id="officer_body">
							    	@if(isset($applications) && count($applications) > 0)
								        @foreach($applications as $app)
								            <tr>
								                ...
								                <td><input name="person_contact[]" class="form-control" value="{{ $app->person_contact }}" id="phone" type="text" minlength="10" maxlength="10" pattern="[0-9]{10}" oninput="this.value=this.value.replace(/[^0-9]/g,'');"></td>
								    ...
								    @else
									    <tr>
							                ...
							                <td>
							                	<input name="person_contact[]" class="form-control" value="{{ old('person_contact.0') }}" id="phone" type="text" minlength="10" maxlength="10" pattern="[0-9]{10}" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
							                </td>
                            ...
                            @endphp
                            	...
                            	<div class="form-group">
								  <div class="row">
								    <div class="col-lg-12 col-md-12 col-xs-12">
								      <label class="control-label" for="center_afflilation_doc">Center Afflilation Certificate <span class="text-danger">*</span></label>
								      ...
								      @endif
								      <small><span id="err-center_afflilation_doc" class="text-danger"></span></small>
								  ...
								  <div class="form-group">
									  <div class="row">
									    <div class="col-lg-6 col-md-12 col-xs-12">
									      <label class="control-label" for="traner_certificate">Trainer Certificate <span class="text-danger">*</span></label>
									      ...
									      @endif
									      <small><span id="err-traner_certificate" class="text-danger"></span></small>
									      <span class="text-danger err-msg" id="err-traner_certificate"></span>
									    </div>
									    
									    <div class="col-lg-6 col-md-6 col-xs-12">
									      <label class="control-label" for="on_boarding_file">Proof of registration on AEBAS portal (Screenshot of the registered participants on central.nise.res.in) <span class="text-danger">*</span></label>
									      <input type="file" name="on_boarding_file" id="on_boarding_file" accept=".pdf, .jpg, .jpeg, .png" class="form-control checkFile" style="width:80%">
									      @if($center->on_boarding_file)
									        <a href="{{ asset('uploads/centers/'.$center->on_boarding_file) }}" target="_blank">View</a>
									      @endif
									      <small><span id="err-on_boarding_file" class="text-danger"></span></small>
								  ...
								  <div class="row">
								  <div class="col-lg-6 col-md-12 col-xs-12">
								      <label class="control-label" for="cctv_camera_file">CCTV Camera's Login Details [Classroom, Laboratory and Hostel, Mess]<span class="text-danger">*</span></label>
								      ...
								      @endif
								      <small><span id="err-cctv_camera_file" class="text-danger"></span></small>
								  ...
								  <div class="col-lg-6 col-md-6 col-xs-12">
									...
									<input type="date" name="affiliation_valid_from" id="affiliation_valid_from" value="{{$center->affiliation_valid_from}}" class="form-control datepicker " placeholder="Enter valid date in MM/DD/YYY format" value="">
									@if($center->affiliation_valid_from)
									  <a href="{{ asset('uploads/centers/'.$center->affiliation_valid_from) }}" target="_blank">View</a>
									@endif
								  ...
								  <div class="col-lg-6 col-md-12 col-xs-12">
									...
									<input type="date" name="affiliation_valid_to" id="affiliation_valid_to" value="{{$center->affiliation_valid_to}}" class="form-control datepicker " placeholder="Enter valid date in MM/DD/YYY format" value="">
									@if($center->affiliation_valid_to)
									  <a href="{{ asset('uploads/centers/'.$center->affiliation_valid_to) }}" target="_blank">View</a>
									@endif
								  ...
								  <div class="row">
								  <div class="col-lg-6 col-md-12 col-xs-12">
								      <label class="control-label" for="mobilisation">Proof of advertisement for mobilisation of participants<span class="text-danger">*</span></label>
								      ...
								      @endif
								      <small><span id="err-mobilisation" class="text-danger"></span></small>
								      <span class="text-danger err-msg" id="err-mobilisation"></span>
								    </div>
								  <div class="col-lg-6 col-md-6 col-xs-12">
								      <label class="control-label" for="sip_id_proof">Proof of registration on SIP portal (Screenshot of the registered participants on SIP portal)<span class="text-danger">*</span></label>
								      ...
								      @endif
								      <small><span id="err-sip_id_proof" class="text-danger"></span></small>
		                        ...
		                        <div class="form-group text-right">
		                            <!-- <a href="{{ route('admin.manageCenter') }}" class="btn btn-danger">Cancel</a>
