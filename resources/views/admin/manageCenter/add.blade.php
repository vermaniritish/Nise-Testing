        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                ...
                @endif
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.manageCenter.add') }}" enctype="multipart/form-data">
                            @csrf 
                            <div class="row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="phone" class="form-control" value="{{ old('phone') }}" id="phone" type="text" minlength="10" maxlength="10" pattern="[0-9]{10}" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
								    ...
								    <select name="academic_session" class="form-control">
								        ...
								        @foreach($sessions as $session)
								            <option value="{{ $session }}" 
								                {{ old('academic_session') == $session ? 'selected' : '' }}>
								                {{ $session }}
								            </option>
								        @endforeach
								    </select>
                            ...
                            @endphp
                            	...
                            	<div class="form-group">
								  ...
								  <div class="col-lg-6 col-md-6 col-xs-12">
									...
									<input type="date" name="affiliation_valid_from" id="affiliation_valid_from" value="" class="form-control datepicker " placeholder="Enter valid date in MM/DD/YYY format" value="">
								  ...
								  <div class="col-lg-6 col-md-12 col-xs-12">
									...
									<input type="date" name="affiliation_valid_to" id="affiliation_valid_to" value="" class="form-control datepicker " placeholder="Enter valid date in MM/DD/YYY format" value="">
								  ...
								  <div class="col-lg-6 col-md-6 col-xs-12">
									...
									<input type="text" name="sip_id" id="sip_id" value="" class="form-control" placeholder="Skill india portal id">
