<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="<?php echo route('admin.district') ?>" id="filters-form">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="custom-control custom-radio custom-control-inline">
							...
							<label class="custom-control-label" for="active">Actice</label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
			...
			<div class="dropdown-divider"></div>
			<a href="<?php echo route('admin.district') ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
