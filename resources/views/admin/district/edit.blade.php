	...
	<div class="row">
		<div class="col-xl-12 order-xl-1">
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.district.edit', ['id' => $district->id]) ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
						...
						<div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <select name="state_id" class="form-control" required>
                                    ...
                                    @foreach($states as $s)
							      		<option value="{{ $s['id'] }}" {{ isset($district->state_id) && $district->state_id == $s['id'] ? 'selected' : '' }}>{{ $s->name }}</option>
							  		@endforeach
                                </select>
                                @error('state_id')
