			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						{{-- <?php if(Permissions::hasPermission('contact_us', 'create')): ?>
						<a href="<?php echo route('admin.contactUs.add') ?>" class="btn btn-neutral"><i class="fas fa-plus"></i>New</a>
						<?php endif;?> --}}
...
<!--!!!!! DO NOT REMOVE listing-block CLASS. INCLUDE THIS IN PARENT DIV OF TABLE ON LISTING PAGES !!!!!-->
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						<div class="heading">
							<h3 class="mb-0">Here Is Your Contact Us!</h3>
						</div>
						<div class="actions">
							...
							<div class="dropdown" data-toggle="tooltip" data-email="Bulk Actions" >
							...
							<thead class="thead-light">
								<tr>
									...
									<th class="sort" width="10%">
										Name
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.name' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="contact_us.name" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.name' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="contact_us.name" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="contact_us.name"></i>
										<?php endif; ?>
									</th>
									...
									<th class="sort" width="20%">
										Phone Number
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.phone_number' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="contact_us.phone_number" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.phone_number' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="contact_us.phone_number" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="contact_us.phone_number"></i>
										<?php endif; ?>
									</th>
									<th class="sort" width="20%">
										Message
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.message' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="contact_us.message" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'contact_us.message' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="contact_us.message" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="contact_us.message"></i>
										<?php endif; ?>
									</th>
									<th class="sort" width="15%">
										Created On
