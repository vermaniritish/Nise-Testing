...
<tr>
    ...
    <td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'video_gallery', 'field' => 'status', 'id' => $row->id]); ?>
	...
	<td class="text-right">
		<?php if(Permissions::hasPermission('video_gallery', 'update') || Permissions::hasPermission('video_gallery', 'delete')): ?>
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
					...
					<a class="dropdown-item" href="<?php echo route('admin.videoGallery.edit', ['id' => $row->id]) ?>">
					...
					<a
						...
						href="javascript:;"
						data-link="<?php echo route('admin.videoGallery.delete', ['id' => $row->id]) ?>"
					>
