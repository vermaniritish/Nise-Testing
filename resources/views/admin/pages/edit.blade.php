...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Edit Page</h6>
                    </div>
    ...
    <div class="container-fluid mt--6">
        <form method="post" action="<?php echo route('admin.pages.edit',$page->id); ?>" class="form-validation">
            {{ @csrf_field() }}
            <div class="row">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-control-label">Description</label>
                                            <textarea rows="2" id="editor2" class="form-control" required placeholder="Description" name="description_hi"><?php echo $page->description_hi ?? ''; ?></textarea>
