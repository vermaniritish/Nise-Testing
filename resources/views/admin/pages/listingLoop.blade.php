	...
	<td class="text-right">
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                ...
                <?php endif; ?>
                <?php if(!in_array($row->slug, ['disclaimer', 'copyright-privacy-policy'])): ?>
                    <?php if(Permissions::hasPermission('pages', 'delete')): ?>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item _delete"
                            href="javascript:;"
                            data-link="<?php echo route('admin.pages.delete', ['id' => $row->id]) ?>"
                        >
