                        ...
                        <form method="POST" action="{{ route('admin.manageCenter.edit', $center->id) }}" enctype="multipart/form-data">
							    ...
							    <tbody id="officer_body">
							    	@if(isset($applications) && count($applications) > 0)
								        @foreach($applications as $app)
								            <tr>
								                ...
								                <td><input type="text" name="person_contact[]" class="form-control" value="{{ $app->person_contact }}"></td>
								    ...
								    @else
									    <tr>
							                ...
							                <td><input type="text" name="person_contact[]" class="form-control" value="{{ old('person_contact') }}"></td>
                            ...
                            <div class="form-group">
								  ...
								  <div class="col-lg-12 col-md-12 col-xs-12">
									...
									@if($center->center_afflilation_doc_File)
									  <a href="{{ asset('uploads/centers/'.$center->center_afflilation_doc_File) }}" target="_blank">View</a>
									@endif
								  ...
								  <div class="col-lg-6 col-md-12 col-xs-12">
									...
									@if($center->traner_certificate_File)
									  <a href="{{ asset('uploads/centers/'.$center->traner_certificate_File) }}" target="_blank">View</a>
									@endif
