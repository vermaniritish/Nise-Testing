...
<tr>
    ...
    <td>
		<div class="custom-control">
			<label class="custom-toggle">
				<?php $switchUrl =  route('admin.actions.switchUpdate', ['relation' => 'gallery', 'field' => 'status', 'id' => $row->id]); ?>
	...
	<td class="text-right">
		<?php if(Permissions::hasPermission('gallery', 'update') || Permissions::hasPermission('gallery', 'delete')): ?>
			<div class="dropdown">
				<a class="btn btn-sm btn-icon-only text-warning" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<i class="fas fa-ellipsis-v"></i>
				</a>
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
					<?php if(Permissions::hasPermission('gallery', 'update')): ?>
					<a class="dropdown-item" href="<?php echo route('admin.gallery.edit', ['id' => $row->id]) ?>">
					...
					<a
						...
						href="javascript:;"
						data-link="<?php echo route('admin.gallery.delete', ['id' => $row->id]) ?>"
					>
