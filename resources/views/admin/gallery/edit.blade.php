...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <form method="post" action="<?php echo route('admin.gallery.edit', ['id' => $gallery->id]); ?>" class="form-validation" novalidate="novalidate">
            <!--!! CSRF FIELD !!-->
            {{ @csrf_field() }}
            <div class="row">
                <div class="col-xl-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control">
                                                <label class="custom-toggle">
                                                    ...
                                                    <input type="checkbox" name="status" value="1"
                                                        <?php echo $gallery->status != '0' ? 'checked' : ''; ?>>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="upload-image-section" data-type="image" data-multiple="true"
                                            ...
                                            <textarea class="d-none" name="image">{{ $gallery->image ?? '' }}</textarea>
