            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form @submit.prevent="submitCoursesForm">
                                <div class="">
                                    <draggable v-model="coursesItems" :options="{group:'courses'}">
                                    <div class="row" v-for="(item, index) in coursesItems" :key="index">
                                        <div class="col-lg-1 text-right">
                                            <i class="drag-point fa fa-grip-vertical" style="background: linen;padding: 4px;cursor: grab;font-size: 16px;margin-top:10px;"></i>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-title">Title</label>
                                                <input type="text" class="form-control" v-model="item.title" placeholder="Title">
                                                <small class="text-danger" v-if="footerErrors[`coursesItems.${index}`] && footerErrors[`coursesItems.${index}`].title">
                                                    @{{ footerErrors[`coursesItems.${index}`].title[0] }}
                                                </small>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-link">Link</label>
                                                <input type="text" class="form-control" v-model="item.link" placeholder="Link">
                                                <small class="text-danger" v-if="footerErrors[`coursesItems.${index}`] && footerErrors[`coursesItems.${index}`].link">
                                                    @{{ footerErrors[`coursesItems.${index}`].link[0] }}
                                                </small>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 d-flex align-items-center">
                                            <button type="button" class="btn btn-danger" @click="removeCourseItem(index)" style="margin-top: 0;">
                                                <i class="fa fa-times"></i>
                                            </button>
                                        </div>
                                    </div>
