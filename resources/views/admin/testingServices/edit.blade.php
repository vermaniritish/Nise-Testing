...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <form method="post" action="<?php echo route('admin.testingService.edit', $page->id); ?>" class="form-validation">
            <!--!! CSRF FIELD !!-->
            {{ @csrf_field() }}
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Create New Testing Service Here.</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="heading-small text-muted mb-4">Testing Service information</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <!-- <div class="col-lg-12">
