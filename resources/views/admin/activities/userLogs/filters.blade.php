<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="<?php echo route('admin.activities.userLogs') ?>" id="filters-form">
			<a href="javascript:;" class="float-right px-2 closeit"><i class="fa fa-times-circle"></i></a>
			
			<!-- <div class="dropdown-item">
				<div class="row">
					<div class="col-md-12">
						<label class="form-control-label">Admins</label>
			...
			<div class="dropdown-item">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" id="onlyrole" name="role" value="client" <?php echo (isset($_GET['role']) && $_GET['role'] == 'client' ? 'checked' : '') ?> class="custom-control-input">
							<label class="custom-control-label" for="onlyrole">Only Client</label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" id="superrole" name="role" value="admin" <?php echo (isset($_GET['role']) && $_GET['role'] == 'admin' ? 'checked' : '') ?> class="custom-control-input">
							<label class="custom-control-label" for="superrole">Only Admins</label>
						</div>
					</div>
				</div>
			</div>
			<div class="dropdown-divider"></div>
			<a href="<?php echo route('admin.activities.userLogs') ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
