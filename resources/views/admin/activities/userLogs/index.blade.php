			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						@include('admin.activities.userLogs.filters')
					</div>
				</div>
			</div>
		</div>
...
<!--!!!!! DO NOT REMOVE listing-block CLASS. INCLUDE THIS IN PARENT DIV OF TABLE ON LISTING PAGES !!!!!-->
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						<div class="heading">
							<h3 class="mb-0">Here Is Your Activity User Log!</h3>
						</div>
						<div class="actions">
						...
						<table class="table align-items-center table-flush listing-table view-table">
							<thead class="thead-light">
								<tr>
									...
									<th class="sort">
										Mobile OTP
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'admin.mobile_otp' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="admin.mobile_otp" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'admin.mobile_otp' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="admin.mobile_otp" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="admin.mobile_otp"></i>
										<?php endif; ?>
									</th>
									<th class="sort">
										Email
									...
									<th class="sort">
										Email OTP
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'users.email_otp' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="users.email_otp" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'users.email_otp' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="users.email_otp" data-sort="desc"></i>
										<?php else: ?>
										<i class="fas fa-sort" data-field="users.email_otp"></i>
										<?php endif; ?>
									</th>
									<th class="sort">
										Created ON
							...
							<tbody class="list">
								<?php if(!empty($listing->items())): ?>
									@include('admin.activities.userLogs.listingLoop')
								<?php else: ?>
