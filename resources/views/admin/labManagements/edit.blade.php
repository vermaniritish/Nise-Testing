...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <form method="post" action="<?php echo route('admin.labManagements.edit', $page->id); ?>" class="form-validation">
            <!--!! CSRF FIELD !!-->
            {{ @csrf_field() }}
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Create New Lab Management Here.</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="heading-small text-muted mb-4">Lab Management information</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-first-name">Lab Name</label>
                                            <input type="text" maxlength="100" value="{{ old('name', $page->name) }}" required class="form-control"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="300" value="{{ old('location', $page->location) }}" required class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type_id" id="type_id" class="form-control" required>
                                                ...
                                                @foreach($testingServices as $testingServices)
                                                    <option value="{{ $testingServices['id'] }}" {{ isset($page->type_id) && $page->type_id == $testingServices->id ? 'selected' : '' }}>{{ $testingServices->title }}</option>
                                                @endforeach
                                            </select>
                                            @error('type_id')
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" maxlength="200" value="{{ old('contact_detail', $page->contact_detail) }}" required class="form-control"
