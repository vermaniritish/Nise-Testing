    ...
    <td>
        <div class="custom-control">
            <label class="custom-toggle">
                <?php $switchUrl = route('admin.actions.switchUpdate', ['relation' => 'header_ads', 'field' => 'status', 'id' => $row->id]); ?>
    ...
    <td class="text-center">
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                <a class="dropdown-item" href="<?php echo route('admin.headerAds.view', ['id' => $row->id]); ?>">
                    <i class="fas fa-eye text-yellow"></i>
                    <span class="status">View</span>
                </a>
                <div class="dropdown-divider"></div>
                <?php if(Permissions::hasPermission('header_ads', 'update')): ?>
                <a class="dropdown-item" href="<?php echo route('admin.headerAds.edit', ['id' => $row->id]); ?>">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item _delete" href="javascript:;" data-link="<?php echo route('admin.headerAds.delete', ['id' => $row->id]); ?>">
