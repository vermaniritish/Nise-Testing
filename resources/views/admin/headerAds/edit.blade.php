...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="<?php echo route('admin.headerAds'); ?>" class="btn btn-neutral"><i class="ni ni-bold-left"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
        <form method="post" action="<?php echo route('admin.headerAds.edit', $page->id); ?>" class="form-validation">
            <!--!! CSRF FIELD !!-->
            {{ @csrf_field() }}
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Create New Header Ads Here.</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <h6 class="heading-small text-muted mb-4">Header Ads information</h6>
                            {{-- <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="url_link"
                                                value="<?php echo $page->url_link ?? ''; ?>" placeholder="Url Link">
                                            @error('url_link')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="custom-control">
                                                <label class="custom-toggle">
                                                    <input type="hidden" name="is_new" value="0" <?php echo isset($page->is_new) && $page->is_new != '1' ? 'checked' : ''; ?>>
