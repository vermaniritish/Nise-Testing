			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						<a href="<?php echo route('admin.headerAds') ?>" class="btn btn-neutral"><i class="fa fa-arrow-left"></i> Back</a>
						<div class="dropdown" data-toggle="tooltip" data-title="More Actions">
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
								<a class="dropdown-item" href="<?php echo route('admin.headerAds.edit', ['id' => $page->id]) ?>">
								...
								<a
									...
									href="javascript:;"
									data-link="<?php echo route('admin.headerAds.delete', ['id' => $page->id]) ?>"
								>
				...
				<div class="card">
					...
					<div class="card-header">
						<div class="row align-items-center">
							<div class="col-8">
								<h3 class="mb-0">Header Ads Information</h3>
							</div>
						</div>
					</div>
