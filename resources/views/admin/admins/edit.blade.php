							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="email" id="input-username" required class="form-control" placeholder="info@example.com" name="email"  value="<?php echo $admin->email ?>">
										@error('email')
										    <small class="text-danger">{{ $message }}</small>
										@enderror
									</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="text" id="input-email" required class="form-control" placeholder="9988774455" name="phonenumber"  value="<?php echo $admin->phonenumber ?>" minlength="10" maxlength="10" pattern="[0-9]{10}" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
										@error('phonenumber')
										    <small class="text-danger">{{ $message }}</small>
										@enderror
									</div>
						...
						<div class="pl-lg-4">
							...
							<div class="form-group passwordGroup">
								<div class="input-group">
									<input type="password" autocomplete="off" class="form-control" placeholder="****" aria-label="" aria-describedby="button-addon4" name="password">
