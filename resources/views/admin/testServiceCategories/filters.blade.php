<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="<?php echo route('admin.testServiceCategories') ?>" id="filters-form">
			...
			<div class="dropdown-divider"></div>
			<a href="<?php echo route('admin.testServiceCategories') ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
