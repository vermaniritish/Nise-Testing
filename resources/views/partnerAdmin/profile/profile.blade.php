	...
	<div class="row justify-content-center">
		...
		<!-- <div class="col-lg-3 order-lg-2"> -->
			<div class="card-profile-image">
				<?php $image = $user->getResizeImagesAttribute(); ?>
				...
				<span class="change_profile_icon">
					...
					<input type="file" style="display:none" name="" id="profile_img" data-url="<?php echo route('admin.profile.updatePicture') ?>" data-id="<?php echo $user->id ?>">
				</span>
			</div>
		</div>
	</div>
