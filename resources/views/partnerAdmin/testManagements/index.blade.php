            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        @include('partnerAdmin.testManagements.filters')
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="card listing-block">
                    <!--!! FLAST MESSAGES !!-->
                    @include('partnerAdmin.partials.flash_messages')
                    <!-- Card header -->
                            ...
                            <div class="dropdown" data-toggle="tooltip" data-designation="Bulk Actions" >
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a
                                        ...
                                        onclick="bulk_actions('<?php echo route('partnerAdmin.testManagements.bulkActions', ['action' => 'delete']) ?>', 'delete');">
                        ...
                        <table class="table align-items-center table-flush listing-table">
                            ...
                            <tbody class="list">
                                <?php if(!empty($listing->items())): ?>
                                    @include('partnerAdmin.testManagements.listingLoop')
                                <?php else: ?>
                            ...
                            <tfoot>
                                <tr>
                                    <th align="left" colspan="20">
                                        @include('partnerAdmin.partials.pagination', ["pagination" => $listing])
                                    </th>
                                </tr>
                            </tfoot>
                        </table>
