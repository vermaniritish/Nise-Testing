            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Add New Center</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('partnerAdmin.manageCenter.add') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-xs-12">
                                    <label>Center Name <span class="text-danger">*</span></label>
                                    <input type="text" name="title" value="{{ old('title') }}" class="form-control" placeholder="Please enter name of center">
                                    @error('title') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="col-lg-6 col-md-6 col-xs-12">
                                    <label>Center Id </label>
                                    <input type="text" name="username" value="{{ old('username') }}" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody id="officer_body">
                                    <tr>
                                        <td>
                                            <input type="text" name="person_name[]" class="form-control" value="{{ old('person_name.0') }}">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="email" name="person_email[]" class="form-control" value="{{ old('person_email.0') }}">
                                        </td>
                                        <td>
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-lg-6 col-md-6 col-xs-12">
                                    ...
                                    <input type="text" name="affiliation_valid_from" id="affiliation_valid_from" class="form-control datepicker " placeholder="Enter valid date in MM/DD/YYY format" readonly="" value="">
                                  ...
                                  <div class="col-lg-6 col-md-12 col-xs-12">
                                    ...
                                    <input readonly="" type="text" name="affiliation_valid_to" id="affiliation_valid_to" class="form-control datepicker " placeholder="Enter valid date in MM/DD/YYY format" value="">
...
<script>
    ...
    document.getElementById('addOfficer').addEventListener('click', function(){
        ...
        row.innerHTML = `
            ...
            <td><input name="person_contact[]" class="form-control" id="phone" type="text" minlength="10" maxlength="10" pattern="[0-9]{10}" oninput="this.value=this.value.replace(/[^0-9]/g,'');"></td>
