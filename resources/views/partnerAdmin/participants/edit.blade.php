...
<div class="container-fluid mt--6">
	...
	<div class="row">
        ...
        <div class="card">
			...
			<form action="{{ route('partnerAdmin.participant.edit', $participant->id)}}" method="post" enctype="multipart/form-data">
				@csrf
                <div class="row">
                  <div class="col-md-6">
					...
					<div class="form-group col-md-6">
						...
						<select name="qualification" class="form-control">
						  ...
						  @foreach(['10th','12th','Diploma','Graduation','Post Graduation','ITA'] as $qual)
						    <option value="{{ $qual }}" {{ old('qualification', $participant->qualification) == $qual ? 'selected' : '' }}>{{ $qual }}</option>
						  @endforeach
						</select>
