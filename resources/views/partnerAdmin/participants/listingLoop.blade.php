    ...
    <td class="text-center">
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                <!-- Edit -->
                <a class="dropdown-item" href="{{ route('partnerAdmin.participant.edit', $row->id) }}">
                    <i class="fas fa-pencil-alt text-info"></i>
                    <span class="status">Edit</span>
                </a>

                <div class="dropdown-divider"></div>
                <a class="dropdown-item _delete" href="javascript:;" data-link="<?php echo route('partnerAdmin.participant.delete', ['id' => $row->id]); ?>">
                    <i class="fas fa-times text-danger"></i>
                    <span class="status text-danger">Delete</span>
                </a>
                <!-- Delete -->
                <!-- <a class="dropdown-item _delete" href="javascript:;" 
                   data-link="{{ route('partnerAdmin.participant.delete', $row->id) }}">
                    <i class="fas fa-times text-danger"></i>
                    <span class="status text-danger">Delete</span>
                </a> -->
            </div>
