...
class UsersController extends AppController
{
    ...
    public function add(Request $request, $id = null)
    {
        ...
        $states = State::all();
        return view('admin.users.add', compact('states'));
    }
    ...
    function view(Request $request, $id)
    {
    	...
    	$centers = Center::all();
    	$user = Users::get($id);
    	$assignedCenters = DB::table('user_centers')->where('user_id', $id)->pluck('center_id')->toArray();
    	if($user)
    	{
	    	return view(
				"admin/users/view",
    ...
    public function assignCenters(Request $request, $id)
	{
	    ...
	    // Delete old centers if needed
	    DB::table('user_centers')->where('user_id', $id)->delete();

	    // Insert new selected centers
	    $data = [];
	    ...
	    DB::table('user_centers')->insert($data);

	    return redirect()->back()->with('success', 'Centers assigned successfully.');
	}
