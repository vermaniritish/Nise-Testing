...
class BlogCategoriesController extends AppController
{
    ...
    {  
    	...
    	if($request->get('search'))
    	{
    		...
    		$search = '%' . $search . '%';
    		$where['(blog_categories.id LIKE ? or blog_categories.title LIKE ? or parent.title LIKE ? or owner.first_name LIKE ? or owner.last_name LIKE ?)'] = [$search,$search, $search, $search, $search];
    	}
