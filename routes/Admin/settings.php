...
// Route::get('/settings/gallery', '\App\Http\Controllers\Admin\SettingsController@galleryIndex')
//     ->name('admin.gallery');
// Route::post('/settings/gallery/add', '\App\Http\Controllers\Admin\SettingsController@storeGallery')
