...
Route::get('/activities/user-logs', '\App\Http\Controllers\Admin\ActivitiesController@userLogs')
    ->name('admin.activities.userLogs');

Route::get('/activities/user-logs/{id}/view', '\App\Http\Controllers\Admin\ActivitiesController@userLogView')
    ->name('admin.activities.userLogs.view');