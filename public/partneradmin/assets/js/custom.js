...
$('body').on('change', '#constituency', async function() {



    let val = $(this).val();

    let resp = await fetch(admin_url + '/actions/stations/' + val);
...

    {
        ...
        $('#pollingstation').html(resp.html).selectpicker('refresh');
...
$('body').on('change','#state_id', function(){
    ...
    $('#district_id').empty();
    $.ajax({
        url: site_url + '/partner-admin/actions/districts/' + state_id,
        type: 'get',
        success: function(resp)
        {
...
$('body').on('change','#center_id', function(){
    ...
    $('#batch_id').empty();
    $.ajax({
        url: site_url + '/partner-admin/actions/batch/' + center_id,
        type: 'get',
        success: function(resp)
        {
