...
//                         {
//                             if(fileType == 'image')
//                                 showSection.html('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><img src="'+response.url+'" alt="img"></div>');
//                             else
...
//                         {
//                             if(fileType == 'image')
//                                 showSection.prepend('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><img src="'+response.url+'" alt="img"></div>');
//                             else
...
$("body").on("click", ".upload-image-section .button-ref button", function () {
    ...
    if (fileType && path) {
        ...
        $("#fileUploadForm input").on("change", function () {
            ...
            if( !parent.find('.fileRemover').length || ( parent.find('.fileRemover').length < imageLimit && parent.hasClass('new_collection_image')) || !parent.hasClass('new_collection_image'))
            {
                parentUpload.find('.upload-message').empty();
                parentUpload.find('.upload-message').show();
                $("#fileUploadForm").ajaxSubmit({
                    beforeSend: function () {
                        progerssBar.parent().removeClass("d-none");
                        progerssBar.css("width", "0");
                    ...
                    success: function (response) {
                        if(response.status == 'success')
                        {
                            ...
                            if(!isMultiple)
                            {
                                ...
                                {
                                    showSection.html('<div class="single-image single-video"><a href="javascript:;" class="fileRemover single-cross image video" data-path="'+response.path+'"><i class="fas fa-times"></i></a><video src="'+response.url+'" controls></video></div>');
                                }
                                else
                                {
                                    ...
                                    {
                                        showSection.html('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+response.url+'"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['pdf']) > -1)
                                    {
                                        showSection.html('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/pdf.png"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['docx']) > -1)
                                    {
                                        showSection.html('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/docx.png"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['doc']) > -1)
                                    {
                                        showSection.html('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/doc.jpg"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['txt']) > -1)
                                    {
                                        showSection.html('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/text.png"></a></div>');
                                    }
                                    else
                                    {
                                        showSection.html('<div class="single-file"><a href="'+site_url + response.path +'" target="_blank"><i class="fas fa-file"></i>'+response.name+'</a><a href="javascript:; file" class="fileRemover single-cross file" data-path="'+response.path+'"><i class="fas fa-times-circle"></i></a></div>');
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if($.inArray(ext.toLowerCase(), ['jpg', 'jpeg', 'png']) !== -1)
                                    {
                                        showSection.prepend('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+response.url+'"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['pdf']) > -1)
                                    {
                                        showSection.prepend('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/pdf.png"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['docx']) > -1)
                                    {
                                        showSection.prepend('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/docx.png"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['doc']) > -1)
                                    {
                                        showSection.prepend('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/doc.jpg"></a></div>');
                                    }
                                    else if($.inArray(ext.toLowerCase(), ['txt']) > -1)
                                    {
                                        showSection.prepend('<div class="single-image"><a href="javascript:;" class="fileRemover single-cross image" data-path="'+response.path+'"><i class="fas fa-times"></i></a><a target="_blank" href="'+response.url+'"><img src="'+site_url+'/assets/icon/text.png"></a></div>');
                                    }
                                    else
                                    {
                                        showSection.prepend('<div class="single-file"><a href="'+site_url + response.path +'" target="_blank"><i class="fas fa-file"></i>'+response.name+'</a><a href="javascript:; file" class="fileRemover single-cross file" data-path="'+response.path+'"><i class="fas fa-times-circle"></i></a></div>');
            ...
            {
                parentUpload.find('.upload-message').show();
                parentUpload.find('.upload-message').html("<p class='alert alert-danger'>Can't upload more than "+imageLimit+" images<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button></p>");
                $('.upload-message').delay(5000).fadeOut();
            }
        });
    } else {
        set_notification("error", "File path and type are missing.");
    ...
    if(confirm("Are you sure to delete this file ?"))
    {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if(!relation){
                    updateFileValues(parent.find('textarea'), null, isMultiple);
                }
            }
        });
    }
...
function updateFileValues(textArea, fileType, isMultiple)
{
    if(isMultiple)
    {
        ...
        textArea.parent().find('.fixed-edit-section').find('.fileRemover').each(function() {
            var file = $(this).attr('data-path');
            files.push(file);
        });
        console.log(files);
...
$('body').on('click', '#copy-order-details', function() {
    try {
        // Copy the selected text to the clipboard
        var textarea = document.getElementById("share-with-staff");

        textarea.select();

        document.execCommand("copy").then(function() {
            set_notification('success', 'Copied!')
        }).catch(function(err) {
...
$('#share-order-details').on('click', function() {
...
$('body').on('change','#training_id', function(){
    var training_id = $(this).val();
    $('#batch_id').empty();
    //$('#batch_id').selectpicker('refresh');
    $.ajax({
        url: admin_url + '/get-batches/' + training_id,
        type: 'get',
        success: function(resp)
        {
            $('#batch_id').html(resp.html);
            $('#batch_id').selectpicker('refresh');
        }
    });
});
...
$(".datepicker").datepicker({
    format: "mm/dd/yyyy",   // matches your placeholder
    autoclose: true,
    todayHighlight: true
});
...
$('body').on('change','#state_id', function(){
    ...
    $('#district_id').empty();
    $.ajax({
        url: admin_url + '/actions/districts/' + state_id,
        type: 'get',
        success: function(resp)
        {
...
$('body').on('change','#institute', function(){
    var institute_id = $(this).val();
    $('#center_id').empty();
    $.ajax({
        url: admin_url + '/actions/center/' + institute_id,
        type: 'get',
        success: function(resp)
        {
            $('#center_id').html(resp.html);
...
$('body').on('change','#center_id', function(){
    ...
    $('#batch_id').empty();
    $.ajax({
        url: admin_url + '/actions/batch/' + center_id,
        type: 'get',
        success: function(resp)
        {
            $('#batch_id').html(resp.html);
