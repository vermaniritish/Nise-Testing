var menu = new Vue({
    el: '#menu',
    data: {
        menuItems: [{ id: '', title: '', link: '', slug: 'header', megaMenu: [] }],
    ...
    methods: {
        async fetchMenuItems() {
            try {
                ...
                if (data.menuItems && Array.isArray(data.menuItems))
                    {
                        console.log('this console',data.menuItems);
        ...
        addItem() {
            this.menuItems.push({ id: '', title: '', link: '', slug: 'header', megaMenu: [] });
        },
